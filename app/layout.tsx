      ...
      <body className="flex h-screen bg-gray-50 text-gray-900 font-sans overflow-hidden">
        ...
        <aside className="w-64 bg-white border-r border-gray-200 flex flex-col hidden md:flex">
          ...
          <nav className="flex-1 overflow-y-auto p-4 space-y-1 text-sm font-medium text-gray-600">
            ...
            <Link href="#" className="block p-2 rounded-lg hover:bg-gray-100">Booking Cepat</Link>
            <Link href="#" className="block p-2 rounded-lg hover:bg-gray-100">Workboard</Link>
            <Link href="#" className="flex justify-between p-2 rounded-lg hover:bg-gray-100">
